  ...
  return (
    <div>
      ...
      <button
        ...
        className={`w-full text-sm md:text-xl font-bold py-4 md:py-5 px-4 md:px-8 rounded-full shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 flex items-center justify-center gap-2 md:gap-4 cursor-pointer whitespace-nowrap ${isFormValid
